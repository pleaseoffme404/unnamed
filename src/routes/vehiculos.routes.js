...
router.post('/', 
    ...
    handleUploadError, 
    controller.registrarMiVehiculo
);
...
router.put('/:id', 
    ...
    uploadImage.single('imagen'), 
    handleUploadError, 
    controller.actualizarMiVehiculo
);

router.delete('/:id', isAuthenticated, controller.eliminarMiVehiculo);


router.post('/admin', isAdmin, uploadImage.single('imagen'), handleUploadError, controller.createVehiculo);
router.get('/alumno/:id', isAdmin, controller.getVehiculosByAlumno);
router.put('/admin/:id', isAdmin, uploadImage.single('imagen'), handleUploadError, controller.updateVehiculo);
